# Contributing to Omicron interimProposal

The following is a set of guidelines to contribute to Omicron interimProposal Board and its repositories, which are hosted on the [omicronrobot Organization](https://github.com/omicronrobot) on GitHub.
...
Before raising a new issue, check [our issue list](https://github.com/omicronrobot/interimProposal/issues) to determine if it already contains the problem that you are facing.
...
```bash
git clone https://github.com/<your-username>/interimProposal.git
cd interimProposal
git remote add upstream https://github.com/omicronrobot/interimProposal.git
```
